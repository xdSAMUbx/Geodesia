...
def calc_DATBOG (a,e_cuadrado,e_prim_cuad,alfa,beta,gamma,delta,epsilon):
    ...
    if lon_pto <= -72.58091667 and lon_pto >= -75.58091667:
        ...
        print(f"La coordenada Norte para Bogotá - DATUM con origen gauss - Krüeger  es: {norte}")
        print(f"La coordenada Este para Bogotá - DATUM con origen gauss - Krüeger  es: {este}")
        ...
        print(f"La coordenada Norte para Este - DATUM con origen gauss - Krüeger  es: {norte}")
        print(f"La coordenada Este para Este - DATUM con origen gauss - Krüeger  es: {este}")
        ...
        print(f"La coordenada Norte para Oeste - DATUM con origen gauss - Krüeger  es: {norte}")
        print(f"La coordenada Este para Oeste - DATUM con origen gauss - Krüeger  es: {este}")
        ...
        print(f"La coordenada Norte para Oeste Oeste - DATUM con origen gauss - Krüeger  es: {norte}")
        print(f"La coordenada Este para Oeste Oeste - DATUM con origen gauss - Krüeger es: {este}")
...
def const_ref ():
    ...
    if elip == 1:
        ...
        calc_DATBOG (a,e_cuadrado,e_prim_cuad,alfa,beta,gamma,delta,epsilon)
